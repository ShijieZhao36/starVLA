...
CONFIG_YAML="${CONFIG_YAML:-examples/realRobots/ARX_X5_Dual/train_files/pi05_gr00t_sharded.yaml}"
NUM_PROCESSES="${NUM_PROCESSES:-8}"
DATA_ROOT="${DATA_ROOT:-/mnt/zhaoshijie/dataset_converted/arx_x5_dual/coffee}"
DATA_MIX="${DATA_MIX:-arx_x5_dual}"
TOKENIZER_MODEL="${TOKENIZER_MODEL:-/root/models/big_vision/paligemma_tokenizer.model}"
PRETRAINED_CHECKPOINT="${PRETRAINED_CHECKPOINT:-/root/models/pi05_base_starvla/fp32/model.safetensors}"
RUN_ROOT_DIR="${RUN_ROOT_DIR:-outputs/starvla}"
RUN_ID="${RUN_ID:-starvla_pi05_arx_x5_dual}"
WANDB_PROJECT="${WANDB_PROJECT:-CRA}"
WANDB_ENTITY="${WANDB_ENTITY:-jasperz-georgia-institute-of-technology}"
...
accelerate launch \
  ...
  --datasets.vla_data.dataset_py gr00t_sharded \
